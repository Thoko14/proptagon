...
export const SuburbToolkit: React.FC<SuburbToolkitProps> = ({ growState }) => {
  ...
  return (
    <div
      ...
      style={{
        left: '20px',
        top: '240px' // Position even further down for larger catchment toolkit
      }}
    >
      {/* Header */}
      ...
      <div className="p-4 space-y-4">
        ...
        {toolkitSuburb.isCatchment ? (
          /* Catchment/School Information Only */
          <div dangerouslySetInnerHTML={{ __html: toolkitSuburb.catchmentInfo || '' }} />
        ) : (
          /* Suburb Investment Information */
          <>
            {/* Score Card */}
        ...
        {/* Actions - Only show for suburbs, not catchments */}
        {!toolkitSuburb.isCatchment && (
